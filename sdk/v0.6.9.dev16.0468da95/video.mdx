...
title: "video"
icon: "square-m"
description: "<a href=\"https://github.com/pixeltable/pixeltable/blob/main/pixeltable/functions/video/__init__.py#L0\" id=\"viewSource\" target=\"_blank\" rel=\"noopener noreferrer\"><img src=\"https://img.shields.io/badge/View%20Source%20on%20Github-blue?logo=github&labelColor=gray\" alt=\"View Source on GitHub\" style={{ display: 'inline', margin: '0px' }} noZoom /></a>"
noindex: true
---
...
- `pxt.Audio | None`: The extracted audio, or None if the video has no audio stream at `stream_idx`.
...
## <span style={{ 'color': 'gray' }}>udf</span>&nbsp; pan()
...
) -> pxt.Json[(Json[{'start_time': Float, 'start_pts': Int, 'duration': Float}], ...)]
```
...
- `pxt.Json[(Json[{'start_time': Float, 'start_pts': Int, 'duration': Float}], ...)]`: A list of dictionaries, one for each detected scene, with the following keys:
...
segment_video(
    ...
    *,
    ...
    video_encoder: pxt.String | None = None,
    video_encoder_args: pxt.Json | None = None
) -> pxt.Json[(Json[{'segment_start': Float | None, 'segment_start_pts': Int | None, 'segment_end': Float | None, 'segment_end_pts': Int | None, 'video_segment': Video}], ...)]
```
...
- `pxt.Json[(Json[{'segment_start': Float | None, 'segment_start_pts': Int | None, 'segment_end': Float | None, 'segment_end_pts': Int | None, 'video_segment': Video}], ...)]`: A list of [`VideoSegment`](./videosegment) records, one per generated segment.
