...
<a href="https://github.com/pixeltable/pixeltable/blob/v0.4.19/pixeltable/catalog/table.py#L59" target="_blank">View source on GitHub</a>
...
- **`metric`** (*Literal['cosine', 'ip', 'l2']*) = `cosine`: Distance metric to use for the index; one of `'cosine'`, `'ip'`, or `'l2'`. The default is `'cosine'`.
