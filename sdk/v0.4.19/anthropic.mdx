...
<a href="https://github.com/pixeltable/pixeltable/blob/v0.4.19/pixeltable/functions/anthropic.py#L0" target="_blank">View source on GitHub</a>
...
- **`model_kwargs`** (*Json | None*): Additional keyword args for the Anthropic `messages` API. For details on the available parameters, see: [https://docs.anthropic.com/en/api/messages](https://docs.anthropic.com/en/api/messages)
