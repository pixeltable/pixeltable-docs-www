...
<a href="https://github.com/pixeltable/pixeltable/blob/v0.4.19/pixeltable/functions/llama_cpp.py#L0" target="_blank">View source on GitHub</a>
...
- **`model_kwargs`** (*Json | None*): Additional keyword args for the llama_cpp `create_chat_completions` API, such as `max_tokens`, `temperature`, `top_p`, and `top_k`. For details, see the [llama_cpp create_chat_completions documentation](https://llama-cpp-python.readthedocs.io/en/latest/api-reference/#llama_cpp.Llama.create_chat_completion).
