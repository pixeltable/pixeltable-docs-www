...
<a href="https://github.com/pixeltable/pixeltable/blob/v0.4.18/pixeltable/functions/video.py#L0" target="_blank">View source on GitHub</a>
...
clip(
    ...
    *,
    ...
    video_encoder: Optional[String] = None,
    video_encoder_args: Optional[Json] = None
)-> Optional[Video]
```
...
segment_video(
    ...
    *,
    duration: Optional[Float] = None,
    segment_times: Optional[Json] = None,
    mode: String = 'accurate',
    video_encoder: Optional[String] = None,
    video_encoder_args: Optional[Json] = None
)-> Json
