...
<a href="https://github.com/pixeltable/pixeltable/blob/v0.4.18/pixeltable/functions/whisperx.py#L0" target="_blank">View source on GitHub</a>
...
transcribe(
    ...
    *,
    ...
    alignment_model_name: Optional[String] = None,
    interpolate_method: Optional[String] = None,
    return_char_alignments: Optional[Bool] = None,
    diarization_model_name: Optional[String] = None,
