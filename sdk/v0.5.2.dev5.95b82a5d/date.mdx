...
```python Signature
add_days(self: pxt.Date, n: pxt.Int) -> Date
```
...
```python Signature
isocalendar(self: pxt.Date) -> Json
```
...
```python Signature
make_date(year: pxt.Int, month: pxt.Int, day: pxt.Int) -> Date
```
...
```python Signature
strftime(self: pxt.Date, format: pxt.String) -> String
```
