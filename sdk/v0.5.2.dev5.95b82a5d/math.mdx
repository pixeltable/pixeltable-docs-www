...
```python Signature
bitwise_and(self: pxt.Int, other: pxt.Int) -> Int
```
...
```python Signature
bitwise_or(self: pxt.Int, other: pxt.Int) -> Int
```
...
```python Signature
bitwise_xor(self: pxt.Int, other: pxt.Int) -> Int
```
...
```python Signature
pow(self: pxt.Int, other: pxt.Int) -> Float
```
...
```python Signature
round(self: pxt.Float, digits: pxt.Int | None = None) -> Float
```
