...
<a href="https://github.com/pixeltable/pixeltable/blob/main/pixeltable/iterators/video.py#L226" target="_blank">View source on GitHub</a>
...
```python
accurate_iter(self) -> Iterator[dict[str, Any]]
```
...
```python
fast_iter(self) -> Iterator[dict[str, Any]]
```
