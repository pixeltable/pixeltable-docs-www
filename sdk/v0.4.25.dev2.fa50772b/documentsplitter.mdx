...
icon: "square-c"
---
# `class` pixeltable.iterators.DocumentSplitter

<a href="https://github.com/pixeltable/pixeltable/blob/main/pixeltable/iterators/document.py#L112" target="_blank">View source on GitHub</a>
