...
icon: "square-m"
description: "Pixeltable UDFs that call Mistral AI chat, embedding, and code endpoints as computed columns for European-hosted LLM workloads inside Pixeltable tables."
---
