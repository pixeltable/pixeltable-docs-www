...
icon: "square-m"
description: "Pixeltable UDFs that run hosted Replicate models for image, video, audio, and language generation as computed columns inside Pixeltable tables."
---
