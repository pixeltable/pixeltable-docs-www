...
icon: "square-m"
description: "Pixeltable UDFs that call Groq LPU-hosted LLMs from computed columns for low-latency chat completions on Llama, Mixtral, and other open-source models."
---
