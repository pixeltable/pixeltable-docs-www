---
title: "StreamMetadata SDK reference"
icon: "square-c"
description: "API reference for StreamMetadata, the Pixeltable structure describing per-stream codec, dimension, sample rate, and duration information for media files."
---
