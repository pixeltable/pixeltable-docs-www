---
title: "ColumnMetadata SDK reference"
icon: "square-c"
description: "API reference for ColumnMetadata, the Pixeltable structure that describes a column name, type, nullability, and configuration in table metadata."
---
