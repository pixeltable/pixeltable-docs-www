---
title: "pixeltable.functions.fabric"
icon: "square-m"
description: "Pixeltable UDFs that integrate with Microsoft Fabric and OneLake, allowing Pixeltable tables to read from and write to Fabric Lakehouse data."
---
