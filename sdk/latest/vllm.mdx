---
title: "pixeltable.functions.vllm"
icon: "square-m"
description: "Pixeltable UDFs that call locally or remotely hosted vLLM servers for high-throughput open-source LLM inference inside Pixeltable computed columns."
---
