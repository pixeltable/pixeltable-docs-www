...
icon: "square-m"
description: "Pixeltable UDFs that call Together AI hosted open-source LLMs and embedding models as computed columns for cost-effective Llama and Mixtral inference."
---
