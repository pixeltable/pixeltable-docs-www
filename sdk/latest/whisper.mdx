...
icon: "square-m"
description: "Pixeltable UDFs that wrap the local OpenAI Whisper model for audio transcription as a computed column, with multilingual support and segment outputs."
---
