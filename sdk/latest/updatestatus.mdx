---
title: "UpdateStatus SDK reference"
icon: "square-c"
description: "API reference for UpdateStatus, the Pixeltable structure returned by inserts and updates that reports row counts, errors, and per-column processing stats."
---
