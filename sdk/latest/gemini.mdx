...
icon: "square-m"
description: "Pixeltable UDFs that call Google Gemini text, vision, and multimodal endpoints as computed columns, with tool calling and structured JSON output."
---
