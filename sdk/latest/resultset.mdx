---
title: "ResultSet SDK reference"
icon: "square-c"
description: "API reference for ResultSet, the in-memory collection of rows returned by Pixeltable queries, with column accessors, conversion, and iteration helpers."
---
