...
icon: "square-m"
description: "Pixeltable UDFs that call Reve image generation and editing endpoints as computed columns to add Reve models to your text-to-image pipelines."
---
