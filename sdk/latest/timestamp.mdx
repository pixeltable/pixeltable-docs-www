...
icon: "square-m"
description: "Pixeltable UDFs for TimestampType columns: extract date and time components, time-zone conversion, and arithmetic helpers for time-series queries."
---
