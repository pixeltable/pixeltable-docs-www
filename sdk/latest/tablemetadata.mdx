---
title: "TableMetadata SDK reference"
icon: "square-c"
description: "API reference for TableMetadata, the Pixeltable structure describing a table columns, indexes, parent paths, versioning, and other catalog metadata."
---
