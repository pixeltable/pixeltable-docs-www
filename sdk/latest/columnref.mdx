---
title: "ColumnRef SDK reference"
icon: "square-c"
description: "API reference for ColumnRef, the Pixeltable expression that references a column by name and is used to build queries, filters, and computed expressions."
---
