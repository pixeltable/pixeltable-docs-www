---
title: "Table SDK reference"
icon: "square-c"
description: "API reference for the Pixeltable Table class: insert, update, delete, add columns and indexes, run queries, and manage views and snapshots."
---
...
```python Signature
group_by(*items: exprs.Expr) -> Query
```
