---
title: "ContainerMetadata SDK reference"
icon: "square-c"
description: "API reference for ContainerMetadata, the Pixeltable structure describing container-level metadata for media files such as videos and audio."
---
