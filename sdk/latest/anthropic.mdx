...
icon: "square-m"
description: "Pixeltable UDFs that wrap Anthropic Claude API endpoints, including messages and tool calling, for use as computed columns inside Pixeltable tables."
---
