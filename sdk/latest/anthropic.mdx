...
```python Signature
@pxt.udf
messages(messages: pxt.Json[(Json, *, model: pxt.String, max_tokens: pxt.Int, model_kwargs: pxt.Json | None = None, tools: pxt.Json[(Json = None, tool_choice: pxt.Json | None = None) -> pxt.Json
```
