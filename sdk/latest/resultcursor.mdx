---
title: "ResultCursor SDK reference"
icon: "square-c"
description: "API reference for ResultCursor, the Pixeltable cursor used to iterate over rows of a query result lazily without loading the full result set into memory."
---
