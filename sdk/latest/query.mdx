---
title: "Query SDK reference"
icon: "square-c"
description: "API reference for the Pixeltable Query class, the DataFrame-style query builder used to select, filter, join, group, and order rows from tables."
---
