...
icon: "square-m"
description: "Pixeltable UDFs that call locally hosted Ollama LLMs from computed columns for private, offline chat and embedding inference on Llama, Mistral, and more."
---
