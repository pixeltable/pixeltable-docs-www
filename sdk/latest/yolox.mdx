...
icon: "square-m"
description: "Pixeltable UDFs that wrap the YOLOX object detection library as computed columns for bounding-box, label, and confidence detection on image columns."
---
