...
icon: "square-m"
description: "Pixeltable UDFs for ImageType columns: PIL operations, resize and crop, color and filter transforms, drawing, and image composition inside tables."
---
