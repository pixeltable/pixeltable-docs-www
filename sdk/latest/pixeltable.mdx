---
title: "pixeltable package reference"
icon: "square-m"
description: "Top-level pixeltable package reference: table creation, data manipulation, queries, expressions, UDF registration, and catalog management APIs."
---
