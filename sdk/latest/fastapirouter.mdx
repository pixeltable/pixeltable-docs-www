---
title: "FastAPIRouter SDK reference"
icon: "square-c"
description: "API reference for FastAPIRouter, the Pixeltable router that exposes tables, views, and queries as FastAPI HTTP endpoints with typed request and response models."
---
