---
title: "pixeltable.functions.jina"
icon: "square-m"
description: "Pixeltable UDFs that call Jina AI embedding and reranking endpoints as computed columns to build multilingual and multimodal retrieval pipelines."
---
