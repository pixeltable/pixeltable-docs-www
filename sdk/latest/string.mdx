...
icon: "square-m"
description: "Pixeltable UDFs for StringType columns, closely modeled on the pandas pandas.Series.str API for string slicing, splitting, regex, and case operations."
---
