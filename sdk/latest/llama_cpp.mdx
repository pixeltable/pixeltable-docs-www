...
icon: "square-m"
description: "Pixeltable UDFs that run quantized GGUF LLMs locally with llama.cpp as computed columns, enabling offline chat and completion inference inside tables."
---
...
- **`model_kwargs`** (`Any`): Additional keyword args for the llama_cpp `create_chat_completion` API, such as `max_tokens`,
