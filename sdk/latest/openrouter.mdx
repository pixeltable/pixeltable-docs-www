...
chat_completions(
    ...
    *,
    ...
    tools: pxt.Json[(Json = None, tool_choice: pxt.Json | None = None, provider: pxt.Json | None = None, transforms: pxt.Json[(String = None
) -> pxt.Json
```
...
- **`tools`** (`pxt.Json[(Json`): List of tools available to the model.
