...
icon: "square-m"
description: "Pixeltable UDFs that call LLMs through the OpenRouter gateway as computed columns, giving you a single API key for hundreds of hosted chat models."
---
