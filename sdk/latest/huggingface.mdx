...
icon: "square-m"
description: "Pixeltable UDFs that wrap Hugging Face transformers, sentence-transformers, and diffusion pipelines for embedding, NLP, and vision computed columns."
---
