...
icon: "square-m"
description: "Pixeltable UDFs for working with JsonType columns: JSON path extraction, parsing, and projection of nested fields into typed query expressions."
---
