...
icon: "square-m"
description: "Pixeltable vision UDFs for evaluating and benchmarking object detection, including IoU, mean average precision, and other detection-metric helpers."
---
