---
title: "Expr SDK reference"
icon: "square-c"
description: "API reference for Expr, the Pixeltable expression base class that represents columns, literals, function calls, and composite query expressions."
---
