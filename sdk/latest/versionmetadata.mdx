---
title: "VersionMetadata SDK reference"
icon: "square-c"
description: "API reference for VersionMetadata, the Pixeltable structure that describes a single version of a table, including author, timestamp, and operation log."
---
