...
icon: "square-m"
description: "Pixeltable UDFs that call Fireworks AI hosted LLMs from computed columns to add fast open-source completions and chat models to your Pixeltable pipelines."
---
