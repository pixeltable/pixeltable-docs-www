---
title: "pixeltable.functions.bfl"
icon: "square-m"
description: "Pixeltable UDFs that call BFL FLUX image generation and editing endpoints, including text-to-image and Kontext models, from inside Pixeltable tables."
---
