...
icon: "square-m"
---
<a href="https://github.com/pixeltable/pixeltable/blob/v0.3/pixeltable/functions/llama_cpp.py#L0" target="_blank">View source on GitHub</a>
...
- **`args`** (*Optional[Json]*): Additional arguments to pass to the `create_chat_completions` call, such as `max_tokens`, `temperature`, `top_p`, and `top_k`. For details, see the [llama_cpp create_chat_completions documentation](https://llama-cpp-python.readthedocs.io/en/latest/api-reference/#llama_cpp.Llama.create_chat_completion).
