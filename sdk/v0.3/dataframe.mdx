...
icon: "square-c"
---
<a href="https://github.com/pixeltable/pixeltable/blob/v0.3/pixeltable/dataframe.py#L132" target="_blank">View source on GitHub</a>
...
- **`on`** (*Optional[Union[exprs.Expr, Sequence[exprs.ColumnRef]]]*): the join condition, which can be either a) references to one or more columns or b) a boolean expression.
