...
## <span style={{ 'color': 'gray' }}>func</span>&nbsp; array()
...
- **`table`** (`str | catalog.Table`): Fully qualified name or table handle of the table to be dropped.
...
## <span style={{ 'color': 'gray' }}>func</span>&nbsp; get_dir_tree()

```python Signature
get_dir_tree(path: str = '') -> list['TreeNode']
```
...
- **`path`** (`str`, default: `''`): Path to the directory to start from. Defaults to the root directory.
...
## <span style={{ 'color': 'gray' }}>func</span>&nbsp; iterator()
...
## <span style={{ 'color': 'gray' }}>func</span>&nbsp; list_dirs()
...
## <span style={{ 'color': 'gray' }}>func</span>&nbsp; list_functions()
...
## <span style={{ 'color': 'gray' }}>func</span>&nbsp; list_tables()
...
To get a programmatic list of the directory's contents, use [get_dir_contents()](./pixeltable#func-get_dir_contents)
instead.


## <span style={{ 'color': 'gray' }}>func</span>&nbsp; mcp_udfs()
...
## <span style={{ 'color': 'gray' }}>func</span>&nbsp; query()
...
## <span style={{ 'color': 'gray' }}>func</span>&nbsp; retrieval_udf()
...
## <span style={{ 'color': 'gray' }}>func</span>&nbsp; tool()
...
## <span style={{ 'color': 'gray' }}>func</span>&nbsp; tools()
...
## <span style={{ 'color': 'gray' }}>func</span>&nbsp; uda()
...
## <span style={{ 'color': 'gray' }}>func</span>&nbsp; udf()
