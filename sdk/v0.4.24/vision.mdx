...
- **`font`** (`String | None`): Name of a system font or path to a TrueType font file, as required by
...
- **`min_iou`** (`Float`): Minimum intersection-over-union (IoU) threshold for a predicted bounding box to be
