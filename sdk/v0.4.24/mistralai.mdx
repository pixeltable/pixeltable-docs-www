...
- **`model_kwargs`** (`Json | None`): Additional keyword args for the Mistral `chat/completions` API.
...
- **`model`** (`String`): ID of the model to use. (See overview here: [https://docs.mistral.ai/getting-started/models/](https://docs.mistral.ai/getting-started/models/))
- **`model_kwargs`** (`Json | None`): Additional keyword args for the Mistral `fim/completions` API.
