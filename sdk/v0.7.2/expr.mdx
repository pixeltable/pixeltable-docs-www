...
title: "Expr"
icon: "square-c"
description: "<a href=\"https://github.com/pixeltable/pixeltable/blob/main/pixeltable/exprs/expr.py#L48\" id=\"viewSource\" target=\"_blank\" rel=\"noopener noreferrer\"><img src=\"https://img.shields.io/badge/View%20Source%20on%20Github-blue?logo=github&labelColor=gray\" alt=\"View Source on GitHub\" style={{ display: 'inline', margin: '0px' }} noZoom /></a>"
noindex: true
---
...
```python Signature
astype(new_type: ts.ColumnType | type) -> exprs.TypeCast
```
...
- **`new_type`** (`ts.ColumnType | type`): The type to cast to.
