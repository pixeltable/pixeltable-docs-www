---
title: "Tables and data operations tutorial"
description: "Create Pixeltable tables, insert rows, run updates and deletes, manage views and snapshots, and explore the core data operations of Pixeltable."
