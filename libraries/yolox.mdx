---
title: "YOLOX object detection in Pixeltable"
description: "Run YOLOX, a lightweight PyTorch object detection library, directly inside Pixeltable computed columns for fast and reproducible vision pipelines."
---
