...
description: "YOLOX is a lightweight PyTorch object detection library packaged for Pixeltable, used as a computed column to detect objects in image and video data."
---
