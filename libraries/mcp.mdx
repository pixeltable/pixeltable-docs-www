---
title: "Multimodal MCP servers for Pixeltable"
description: "Expose Pixeltable tables and queries to AI agents through ready-made multimodal MCP servers for documents, images, audio, video, and embeddings."
---
