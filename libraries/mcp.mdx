...
description: "Extend AI agents with Pixeltable MCP servers, which expose tables and computed columns as Model Context Protocol tools for Claude and other clients."
---
