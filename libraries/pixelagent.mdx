...
title: 'Pixelagent'
mode: 'wide'
description: "Pixelagent is an open agent engineering blueprint powered by Pixeltable, with persistent memory, tool calling, and reproducible agent workflows."
---
