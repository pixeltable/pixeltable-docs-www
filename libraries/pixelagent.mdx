---
title: "Build agents with Pixelagent and Pixeltable"
description: "Pixelagent is an agent engineering blueprint powered by Pixeltable, with table-backed memory, tool calling, and reusable patterns for LLM applications."
mode: 'wide'
---
