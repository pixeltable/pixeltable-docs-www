---
title: 'Pixelagent'
description: "Pixelagent is an agent engineering blueprint built on Pixeltable, providing memory, tool calling, and reasoning primitives for AI agent applications."
mode: 'wide'
---
