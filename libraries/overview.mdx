---
title: "Pixeltable libraries and Model Context Protocol"
description: "Discover companion libraries that extend Pixeltable, including MCP servers, Pixelagent for agents, and YOLOX for lightweight object detection."
---
