---
title: 'Quick Start'
description: "Install Pixeltable, create your first table, add a computed column powered by an LLM, and run your first query in just a few minutes of setup."
---
