---
title: "Pixeltable quick start"
description: "Install Pixeltable, create your first table, add a computed column, and run a query in five minutes with this end-to-end quick-start tutorial."
---
