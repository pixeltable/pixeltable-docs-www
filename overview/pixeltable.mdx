...
description: "Pixeltable is declarative AI data infrastructure that provides incremental computed columns, multimodal storage, and versioning in one Python API."
---
