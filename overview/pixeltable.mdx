...
description: 'Data Infrastructure providing a declarative, incremental approach for multimodal AI'
---
...
<CardGroup cols={2}>
  <Card title="Quickstart" icon="bolt" iconType="duotone" href="/overview/quick-start">
...
<AccordionGroup>
  ...
  <Accordion title="Serve" icon="globe">
...
<CardGroup cols={2}>
  <Card title="Data Wrangling for ML" icon="flask" href="/use-cases/ml-data-wrangling">
    Curate, augment, export training datasets. Pre-annotate with models, export to FiftyOne and PyTorch.
  </Card>
...
<Tip>
Start with the **[Quickstart](/overview/quick-start)** to get running in 5 minutes, or explore **[Cookbooks](/howto/cookbooks/agents/pattern-rag-pipeline)** for hands-on examples covering RAG, video analysis, audio transcription, and more.
</Tip>
...
<CardGroup cols={2}>
  ...
  <Card title="Pixeltable Cloud" icon="cloud" iconType="duotone" href="/use-cases/services">
    Managed endpoints and live tables coming soon.
  </Card>
</CardGroup>
