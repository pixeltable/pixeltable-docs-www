...
description: "Pixeltable is declarative AI data infrastructure for multimodal applications, with incremental computed columns over text, images, audio, and video."
---
