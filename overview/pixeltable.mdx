...
description: "Pixeltable is a declarative, incremental data infrastructure for multimodal AI, unifying tables, computed columns, and vector search in one system."
---
