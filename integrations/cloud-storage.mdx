---
title: 'Cloud Storage'
description: "Reference media in S3, Google Cloud Storage, Azure Blob, and other S3-compatible object stores from Pixeltable tables without copying files locally."
---
