---
title: 'Cloud Storage'
description: "Store and serve media files for Pixeltable from cloud storage providers including S3, R2, GCS, Azure Blob, and Tigris with credential setup details."
---
