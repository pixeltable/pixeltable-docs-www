---
title: "Custom embedding models in Pixeltable"
description: "Plug custom embedding models into Pixeltable by wrapping them as UDFs and registering them on table columns to power vector search and retrieval."
---
