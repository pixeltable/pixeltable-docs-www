---
title: "External files in Pixeltable"
description: "Store Pixeltable media as external files in local paths, S3, GCS, and Azure object storage instead of copying them into Pixeltable managed storage."
