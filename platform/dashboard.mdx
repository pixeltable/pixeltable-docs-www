---
title: "Local dashboard for Pixeltable"
sidebarTitle: Dashboard
icon: table-layout
description: "Browse Pixeltable tables, inspect pipelines, preview media, and debug computed columns from the local web dashboard served by the pxt daemon."
---
