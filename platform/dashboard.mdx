...
icon: table-layout
description: "Browse Pixeltable tables, inspect pipelines, preview multimedia, and debug computed columns from a local web dashboard that starts automatically."
---
