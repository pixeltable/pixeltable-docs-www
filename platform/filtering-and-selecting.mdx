...
## title: 'Building Queries' description: 'Learn how to query and transform data in Pixeltable using where() and select()' icon: 'blank'

<Info>
Learn more about queries and expressions with this [in-depth guide](/tutorials/queries-and-expressions).
</Info>
...
<Note>
This guide builds on tables created in previous sections. The `movies` table from [Tables](/platform/tables)
</Note>
