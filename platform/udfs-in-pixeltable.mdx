...
sidebarTitle: "UDFs"
icon: "notebook"
description: "Write Python user-defined functions in Pixeltable to extend tables with custom logic, model inference, and API calls as typed computed columns."
---
