---
title: "Pixeltable as a vector database"
description: "Create, populate, and query embedding indexes in Pixeltable to use it as a vector database alongside structured data, media, and computed columns."
---

<Info>
Learn more about embedding/vector indexes with this [in-depth guide](/platform/embedding-indexes).
</Info>
...
<CardGroup cols={3}>
  <Card title="Audio" icon="volume-high" href="/howto/use-cases/audio-transcriptions">
    Build semantic search for audio files and podcasts
  </Card>
  <Card title="Document" icon="file-pdf" href="/howto/use-cases/rag-demo">
    Search through PDFs and other document formats
  </Card>
  <Card title="Video" icon="film" href="/howto/use-cases/object-detection-in-videos">
    Find relevant content within video libraries
  </Card>
  <Card title="Agent Memory" icon="text" href="https://github.com/pixeltable/pixelagent/tree/main/examples/memory">
...
<Tabs>
  <Tab title="Similarity Search">
    ```python
      sim = docs.content.similarity(string="what is the documentation")
...
<CardGroup cols={3}>
  ...
  <Card title="Embedding Indexes" icon="lightbulb" href="/platform/embedding-indexes">
