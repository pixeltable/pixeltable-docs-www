...
description: "Pixeltable automatically versions every table, computed column, and view, enabling time-travel queries, rollbacks, and full data lineage tracking."
---
