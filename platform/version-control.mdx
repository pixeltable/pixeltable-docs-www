...
description: "Pixeltable automatically versions every table and column, supports time-travel queries, and tracks full data lineage across pipeline changes."
---
