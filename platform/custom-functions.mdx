...
description: "Create custom user-defined functions (UDFs) in Pixeltable to extend computed columns with your own Python logic, including batched and GPU UDFs."
---
