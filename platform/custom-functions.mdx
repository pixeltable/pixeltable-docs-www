---
title: "Custom functions (UDFs) in Pixeltable"
description: "Define Python UDFs in Pixeltable to add custom logic, model inference, and external API calls as reusable computed columns in any table."
---
