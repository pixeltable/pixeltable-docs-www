---
title: "Pixeltable CLI reference (pxt)"
sidebarTitle: "CLI (pxt)"
description: "Use the pxt command-line tool to inspect catalogs, query tables, manage daemons, serve APIs, and run scripts against a Pixeltable installation."
---
