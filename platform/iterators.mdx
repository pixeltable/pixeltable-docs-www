---
title: "View iterators in Pixeltable"
description: "Use Pixeltable iterators to split rows into many child rows, including document, video, audio, and image iterators, exposed as queryable views."
---
