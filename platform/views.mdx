---
title: 'Views'
description: "Use views in Pixeltable to define virtual derived tables backed by queries, iterators, and computed columns without duplicating underlying data."
---
