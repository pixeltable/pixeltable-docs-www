---
title: 'Views'
description: "Create virtual derived tables in Pixeltable with views that filter, transform, or expand rows without copying underlying data or computations."
---
