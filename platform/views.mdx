---
title: "Views in Pixeltable"
description: "Create virtual derived tables (views) in Pixeltable with filters, joins, and iterator expansions that update incrementally as base tables change."
---
