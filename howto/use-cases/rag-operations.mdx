---
title: "Run RAG pipelines in production with Pixeltable"
description: "Operate RAG pipelines in production on Pixeltable: incremental indexing, embedding-index updates, evaluation, and serving retrieval-augmented endpoints."
