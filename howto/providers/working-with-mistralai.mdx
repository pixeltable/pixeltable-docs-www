---
title: "Use Mistral AI models in Pixeltable"
description: "Call Mistral AI chat, embedding, and code models from Pixeltable computed columns to add European-hosted LLMs to your multimodal data pipelines."
