---
title: "Use OpenRouter models in Pixeltable"
description: "Call hundreds of LLMs through the OpenRouter gateway from Pixeltable computed columns with a single API key and unified billing for completions and chat."
