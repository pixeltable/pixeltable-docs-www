...
description: "Route Pixeltable computed columns through OpenRouter to access hundreds of LLMs across providers with a single API key and unified billing."
