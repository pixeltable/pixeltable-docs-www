---
title: "Generate videos with RunwayML in Pixeltable"
description: "Generate short videos from text prompts and reference images with RunwayML Gen-3 models from Pixeltable computed columns and store outputs in tables."
