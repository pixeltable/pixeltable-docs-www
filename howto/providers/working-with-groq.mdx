---
title: "Use Groq LPU models in Pixeltable"
description: "Call Groq's LPU-hosted LLMs from Pixeltable computed columns for low-latency completions on Llama, Mixtral, and other open-source chat models."
sidebarTitle: "Groq"
icon: "notebook"
---
