---
title: "Use AWS Bedrock models in Pixeltable"
description: "Run Anthropic, Mistral, and other AWS Bedrock foundation models from Pixeltable computed columns, with IAM-based auth and per-region configuration."
