---
title: "Use DeepSeek models in Pixeltable"
description: "Call DeepSeek chat and reasoning models from Pixeltable computed columns to add affordable LLM completions and reasoning steps to your pipelines."
