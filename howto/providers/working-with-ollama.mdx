---
title: "Run Ollama models locally with Pixeltable"
description: "Run Ollama-hosted local LLMs from Pixeltable computed columns for private, offline chat and embedding inference on Llama, Mistral, Gemma, and more."
sidebarTitle: "Ollama"
icon: "notebook"
---
