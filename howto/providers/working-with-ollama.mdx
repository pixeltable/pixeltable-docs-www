...
description: "Run local LLMs through Ollama from Pixeltable computed columns, with model pulling, chat completions, embedding endpoints, and offline inference."
sidebarTitle: "Ollama"
icon: "notebook"
---
