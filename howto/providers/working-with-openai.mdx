---
title: "Use OpenAI models in Pixeltable"
description: "Call OpenAI chat, embedding, image, audio, and Whisper models from Pixeltable computed columns with batching, tool calling, and structured output."
sidebarTitle: "OpenAI"
icon: "notebook"
---
