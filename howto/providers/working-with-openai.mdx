...
class="data row1 col3">image_generations(input, model='dall-e-2')</td>
...
-   **`instructions` parameter**: Cleanly separates system-level
    guidance from user input
...
-   **Multi-turn via `previous_response_id`**: Simpler conversation
    state management
