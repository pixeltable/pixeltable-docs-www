...
description: "Call Claude models from Pixeltable computed columns for chat, vision, and tool use, with API key setup, streaming, and structured output examples."
