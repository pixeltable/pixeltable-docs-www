---
title: "Use Anthropic Claude models in Pixeltable"
description: "Call Anthropic Claude models from Pixeltable computed columns for chat, tool use, and structured output, with built-in batching and streaming support."
