---
title: "Use Fireworks AI models in Pixeltable"
description: "Call Fireworks AI hosted LLMs from Pixeltable computed columns to run fast open-source completions and chat models at production scale."
