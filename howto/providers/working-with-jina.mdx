---
title: "Use Jina AI embeddings and rerankers"
description: "Generate Jina embeddings and run Jina rerankers from Pixeltable computed columns to power multilingual and multimodal retrieval pipelines."
