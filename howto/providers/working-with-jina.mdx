...
description: "Generate Jina AI text and multilingual embeddings inside Pixeltable computed columns and index them for semantic search, reranking, and RAG pipelines."
