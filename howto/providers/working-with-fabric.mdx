---
title: "Connect Pixeltable to Microsoft Fabric"
description: "Read from and write to Microsoft Fabric OneLake and Lakehouses from Pixeltable to integrate enterprise data with multimodal AI pipelines."
