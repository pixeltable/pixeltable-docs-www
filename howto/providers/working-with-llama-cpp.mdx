---
title: "Run llama.cpp models locally with Pixeltable"
description: "Run quantized GGUF LLMs locally with llama.cpp from Pixeltable computed columns for offline inference on CPU and GPU without external API calls."
