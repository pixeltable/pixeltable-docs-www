...
description: "Choose a deployment strategy for Pixeltable, from a local single-node setup to a clustered production deployment with shared storage and managed serving."
---
