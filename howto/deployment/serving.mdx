...
description: "Configure and deploy Pixeltable serving endpoints with a TOML service file or Python code to expose tables and computed columns as HTTP APIs."
---
