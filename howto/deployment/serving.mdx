---
title: "Serve Pixeltable queries over HTTP"
sidebarTitle: HTTP Serving
description: "Serve Pixeltable tables and queries as HTTP endpoints using a TOML service file or Python code, with FastAPIRouter integration and authentication options."
---
