---
title: "Iterate on data transformations quickly"
description: "Develop and debug transformations in Pixeltable using incremental computed columns, sample tables, and the dashboard to get fast feedback as you iterate."
