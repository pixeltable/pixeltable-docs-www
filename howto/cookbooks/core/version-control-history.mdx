---
title: "Track history and revert to past versions"
description: "Use Pixeltable's built-in version control to time-travel through table history, revert columns to a previous state, and audit data lineage row by row."
