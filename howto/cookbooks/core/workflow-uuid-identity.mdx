...
icon: "notebook"
description: "Add UUID identity columns to Pixeltable tables to give every row a stable, globally unique identifier for joins, exports, and external systems."
---
