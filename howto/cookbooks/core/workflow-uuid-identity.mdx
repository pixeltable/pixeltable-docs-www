---
title: "Add UUID identifiers to Pixeltable rows"
description: "Add stable UUID primary keys to Pixeltable tables for deduplication, external joins, and idempotent inserts across runs of your ingestion pipelines."
