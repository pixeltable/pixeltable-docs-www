...
<td style="vertical-align: middle;"><code>FastAPIRouter</code> or <code>pxt service</code></td>
</tr>
<tr>
...
production, declare the service in an application file and run
`pxt service update`. See [HTTP
...
computed media flows to cloud. See [Deploy to Pixeltable
Cloud](/howto/deployment/cloud).
...
- [Cookbooks](/use-cases/multimodal-backend)
  (50+ recipes)
- [Docs](/)
