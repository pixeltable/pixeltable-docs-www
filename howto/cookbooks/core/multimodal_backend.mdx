---
title: "Use Pixeltable as a multimodal AI backend"
description: "Build a multimodal AI backend on Pixeltable that ingests images, video, audio, and text and exposes computed columns as queryable API endpoints."
