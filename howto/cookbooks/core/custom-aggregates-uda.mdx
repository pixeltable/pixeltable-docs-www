...
description: "Define custom aggregate functions in Python and register them as Pixeltable UDAs to compute group-wise statistics, rollups, and windowed metrics."
