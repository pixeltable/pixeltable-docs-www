...
icon: "notebook"
description: "Define user-defined aggregate functions (UDAs) in Pixeltable to compute custom group-by statistics over rows with init, update, and value steps."
---
