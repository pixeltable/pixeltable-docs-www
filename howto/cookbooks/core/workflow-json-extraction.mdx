...
description: "Use Pixeltable JSON path expressions and computed columns to extract specific fields from structured LLM responses and project them into typed columns."
