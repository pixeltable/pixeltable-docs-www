...
icon: "notebook"
description: "Extract structured fields from LLM JSON responses in Pixeltable using path expressions, validation, and computed columns for downstream queries."
---
