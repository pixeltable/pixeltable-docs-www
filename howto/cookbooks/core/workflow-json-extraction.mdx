...
description: "Extract structured fields from LLM JSON responses in Pixeltable computed columns using dot notation, schemas, and Pydantic models for type safety."
