...
description: "Configure API keys for OpenAI, Anthropic, Hugging Face, and other providers in Pixeltable using environment variables, config files, and secret managers."
