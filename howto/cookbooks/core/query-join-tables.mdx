---
title: "Join Pixeltable tables in queries"
description: "Combine data across Pixeltable tables with joins and selects to enrich rows with related metadata, embeddings, and computed columns at query time."
