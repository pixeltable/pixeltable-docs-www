---
title: "Detect scene changes in videos with PySceneDetect"
description: "Detect scene boundaries in videos in Pixeltable using PySceneDetect, then split videos into per-scene clips as a view powered by a custom iterator."
