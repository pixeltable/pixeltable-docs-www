...
description: "Detect scene changes and shot boundaries in video columns with Pixeltable, splitting clips into scenes for indexing and downstream analysis."
