...
icon: "notebook"
description: "Build slideshow videos from sequences of images in Pixeltable using FFmpeg-backed UDFs with configurable timing, transitions, and audio tracks."
---
