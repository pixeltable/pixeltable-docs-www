---
title: "Build a video slideshow from images"
description: "Stitch a sequence of images into an MP4 slideshow inside Pixeltable using FFmpeg-backed computed columns with configurable duration and transitions."
