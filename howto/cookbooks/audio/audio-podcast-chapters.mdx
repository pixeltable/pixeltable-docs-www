---
title: "Generate podcast chapters with Whisper and LLMs"
description: "Transcribe podcasts with Whisper, then use an LLM in Pixeltable to detect topic boundaries and generate structured chapter markers and titles."
