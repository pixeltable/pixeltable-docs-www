...
<td style="vertical-align: middle;">Segment length in seconds (mutually exclusive with
<code>max_size</code>)</td>
</tr>
<tr>
<td style="vertical-align: middle;"><code>max_size</code></td>
<td style="vertical-align: middle;">Max segment size in bytes — useful for API upload limits (mutually
exclusive with <code>duration</code>)</td>
</tr>
<tr>
<td style="vertical-align: middle;"><code>overlap</code></td>
<td style="vertical-align: middle;">Overlap between segments in seconds (helps with word
boundaries)</td>
</tr>
<tr>
...
<tr>
<td style="vertical-align: middle;"><code>min_silence_len</code></td>
<td style="vertical-align: middle;">If set, snap cuts to quiet stretches of at least this length
(seconds)</td>
</tr>
<tr>
<td style="vertical-align: middle;"><code>silence_thresh</code></td>
<td style="vertical-align: middle;">dBFS threshold for silence (default <code>-40.0</code>)</td>
</tr>
<tr>
<td style="vertical-align: middle;"><code>trim_leading_silence</code></td>
<td style="vertical-align: middle;">Drop leading silence so each segment starts at audible content</td>
</tr>
</tbody>
</table>
`];
...
```python
# Byte-budget splits (e.g. 24 MB Whisper upload limit)
audio_splitter(audio.audio, max_size=24 * 1024 * 1024)

# Silence-aware duration splits
audio_splitter(
    audio.audio,
    duration=30.0,
    min_silence_len=0.3,
...
Full API:
[audio_splitter](/sdk/latest/audio#iterator-audio_splitter).
