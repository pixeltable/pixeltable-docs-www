...
description: "Transcribe audio files to text in Pixeltable computed columns using OpenAI Whisper, WhisperX, and other speech-to-text models with simple setup."
