...
description: "Transcribe audio files into searchable text with Whisper inside Pixeltable, storing transcripts and segments as computed columns alongside the audio."
