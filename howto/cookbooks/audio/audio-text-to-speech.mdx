---
title: "Generate speech from text with TTS models"
description: "Use Pixeltable computed columns to call OpenAI and ElevenLabs text-to-speech APIs and turn rows of text into audio files inside your tables."
