---
title: "Summarize podcasts and long-form audio"
description: "Transcribe long-form audio in Pixeltable with Whisper and summarize episodes into bullet points and key takeaways using an LLM in a single pipeline."
