...
description: "Extract audio tracks from video files using Pixeltable computed columns, then route the audio to transcription, classification, or analysis pipelines."
