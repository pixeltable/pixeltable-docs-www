...
**What’s in this recipe:** - Extract audio from video as a computed
column - Choose audio format (mp3, wav, flac) - Chain with transcription
for automatic video-to-text
...
video_url = 'https://github.com/pixeltable/pixeltable/raw/main/docs/resources/videos/stockholm-walk.mp4'

videos.insert([{
    'title': 'Stockholm Walk',
    'video': video_url
}])
