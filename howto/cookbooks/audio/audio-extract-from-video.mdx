---
title: "Extract audio tracks from video files"
description: "Use Pixeltable computed columns and FFmpeg to extract audio tracks from video files for transcription, analysis, and audio processing pipelines."
