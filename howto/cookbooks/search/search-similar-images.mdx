---
title: "Find similar images with CLIP embeddings"
description: "Use CLIP embeddings in Pixeltable to index images, then run text-to-image and image-to-image similarity search queries over your visual datasets."
