...
icon: "notebook"
description: "Embed text columns with OpenAI embedding models in Pixeltable to build vector indices for semantic search and retrieval-augmented generation."
---
