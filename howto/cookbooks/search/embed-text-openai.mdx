---
title: "Embed text with OpenAI embeddings"
description: "Generate text embeddings with OpenAI models in Pixeltable computed columns, attach an embedding index, and run vector similarity search at query time."
