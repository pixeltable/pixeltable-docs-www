---
title: "Build semantic text search in Pixeltable"
description: "Build a semantic text search pipeline on Pixeltable tables with embedding indexes, similarity ranking, and hybrid filters for production retrieval."
