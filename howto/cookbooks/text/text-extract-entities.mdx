...
**What’s in this recipe:** - Extract entities as structured JSON - Use
OpenAI’s structured output for reliable parsing - Access extracted
entities as queryable columns
