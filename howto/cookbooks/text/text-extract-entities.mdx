---
title: "Extract named entities from text with LLMs"
description: "Extract named entities like people, organizations, and locations from text in Pixeltable using LLM prompts or transformer NER pipelines as computed columns."
