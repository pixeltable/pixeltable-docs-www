---
title: "Translate text between languages with LLMs"
description: "Translate text columns between languages in Pixeltable with LLMs and Hugging Face translation pipelines, surfacing translations as computed columns."
