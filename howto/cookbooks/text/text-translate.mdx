...
icon: "notebook"
description: "Translate text columns between languages in Pixeltable using OpenAI, Anthropic, and other LLM providers through declarative computed columns."
---
