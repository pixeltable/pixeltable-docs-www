...
<tr>
<td style="vertical-align: middle;">Good Morning. This is the Market Digest for Friday, June 21, 2024,
with analysis of the financial markets and comments on Accenture
plc.</td>
<td style="vertical-align: middle;">0.482</td>
</tr>
<tr>
<td style="vertical-align: middle;">MARKET DIGEST</td>
...
<tbody>
<tr>
<td style="vertical-align: middle;"><code>paragraph</code></td>
<td style="vertical-align: middle;">Split on paragraph breaks</td>
</tr>
<tr>
...
**What’s in this recipe:** - Split PDFs into paragraphs or sentences -
Control chunk size with token limits - Add embeddings for semantic
search
...
&lt;pixeltable.catalog.dir.Dir&nbsp;at&nbsp;0x16e388350&gt;
</pre>
...
<pre style={{ 'margin': '-20px 20px 0px 20px', 'padding': '0px', 'background-color': 'transparent', 'color': 'black' }}>
Inserting&nbsp;rows&nbsp;into&nbsp;\`documents\`:&nbsp;1&nbsp;rows&nbsp;\[00:00,&nbsp;297.36&nbsp;rows/s\]
...
Create a view that splits each document into paragraphs with a token
limit:
...
<pre style={{ 'margin': '-20px 20px 0px 20px', 'padding': '0px', 'background-color': 'transparent', 'color': 'black' }}>
Inserting&nbsp;rows&nbsp;into&nbsp;\`chunks\`:&nbsp;49&nbsp;rows&nbsp;\[00:00,&nbsp;16398.38&nbsp;rows/s\]
</pre>
