---
title: "Chunk documents into RAG-ready passages"
description: "Split long documents into overlapping chunks in Pixeltable using DocumentSplitter and StringSplitter so they fit into LLM context for RAG pipelines."
