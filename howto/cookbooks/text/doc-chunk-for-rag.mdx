...
description: "Split documents into overlapping text chunks in Pixeltable using the document iterator, ready for embedding and retrieval-augmented generation."
