---
title: "Extract text from PowerPoint, Word, and Excel"
description: "Extract clean text from PPTX, DOCX, and XLSX office files in Pixeltable using built-in document parsers so you can index and search Office content."
