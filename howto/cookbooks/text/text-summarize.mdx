---
title: "Summarize text with LLMs in Pixeltable"
description: "Summarize articles, transcripts, and long documents in Pixeltable using OpenAI, Anthropic, and other LLMs, with summaries stored as computed columns."
