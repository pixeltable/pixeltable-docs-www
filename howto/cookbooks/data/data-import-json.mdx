---
title: "Import JSON files into Pixeltable tables"
description: "Import nested JSON and JSON Lines files into Pixeltable tables, project nested fields into typed columns, and combine with computed columns."
