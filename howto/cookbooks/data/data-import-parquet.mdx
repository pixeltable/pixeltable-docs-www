...
description: "Load Parquet files into Pixeltable with column type preservation, useful for ingesting large analytical datasets, embeddings, and ML features."
