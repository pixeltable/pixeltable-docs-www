---
title: "Sample data for training and evaluation"
description: "Sample Pixeltable rows for training and evaluation sets: deterministic seeds, stratified splits, and reproducible train/test/validation partitions."
