---
title: "Import Hugging Face datasets into Pixeltable"
description: "Load Hugging Face datasets into Pixeltable tables in a single call, then add computed columns to embed, transform, and query the imported rows."
