---
title: "Import Excel files into Pixeltable tables"
description: "Import data from XLSX and XLS Excel workbooks into Pixeltable tables, including multi-sheet imports, header handling, and typed column mapping."
