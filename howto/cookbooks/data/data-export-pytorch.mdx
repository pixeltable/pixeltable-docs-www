...
**What’s in this recipe:** - Convert query results to PyTorch Dataset -
Use with DataLoader for batch training - Export to Parquet for external
tools
...
**DataLoader tips:** - Data is cached to disk for efficient repeated
loading - Use `num_workers > 0` for parallel data loading -
