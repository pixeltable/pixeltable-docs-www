---
title: "Export Pixeltable data for PyTorch training"
description: "Stream rows from Pixeltable tables into a PyTorch DataLoader to train models on images, video, audio, and embeddings without an extra ETL step."
