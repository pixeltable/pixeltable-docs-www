---
title: "Import CSV files into Pixeltable tables"
description: "Import rows from CSV files into Pixeltable tables, infer column types automatically, and trigger computed columns to populate as data is inserted."
