...
description: "Import CSV files into Pixeltable tables with automatic schema inference, type conversion, and support for multimodal columns and large datasets."
