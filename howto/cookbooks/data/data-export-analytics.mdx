---
title: "Export Pixeltable data for analytics"
description: "Export Pixeltable tables to pandas, Parquet, and BI tools so analysts can run dashboards and SQL queries against your multimodal data pipelines."
