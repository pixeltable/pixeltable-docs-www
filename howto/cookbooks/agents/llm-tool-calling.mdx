...
description: "Wire LLM tool calling and MCP servers into Pixeltable tables to invoke Python functions, APIs, and external services from inside your prompts."
