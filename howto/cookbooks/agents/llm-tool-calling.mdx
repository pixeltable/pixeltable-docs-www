...
description: "Wire LLM tool calling and MCP server tools into Pixeltable so agents can run UDFs, query tables, and execute actions inside computed columns."
