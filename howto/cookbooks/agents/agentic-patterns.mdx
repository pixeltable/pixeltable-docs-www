...
description: "Reference patterns for building production AI agents in Pixeltable, covering tool calling, memory, retrieval, and multi-step reasoning workflows."
