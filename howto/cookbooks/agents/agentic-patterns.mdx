---
title: "Agentic patterns for LLM workflows"
description: "Explore reusable agentic patterns in Pixeltable for routing, planning, tool use, and multi-step LLM workflows backed by tables and computed columns."
