...
icon: "notebook"
description: "Implement reflection, planning, tool use, and multi-agent collaboration patterns in Pixeltable to build cognitive agents on tabular pipelines."
---
