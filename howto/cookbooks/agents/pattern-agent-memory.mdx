...
icon: "notebook"
description: "Give LLM agents persistent short-term and long-term memory in Pixeltable using conversation tables, summarization, and embedding-based recall."
---
