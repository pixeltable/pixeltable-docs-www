---
title: "Build an LLM agent with persistent memory"
description: "Give your LLM agent persistent memory backed by a Pixeltable table so it can recall past conversations, retrieve context, and reason across sessions."
