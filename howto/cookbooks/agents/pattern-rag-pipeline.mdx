...
description: "Build an end-to-end RAG pipeline in Pixeltable: chunk documents, embed them, run vector search, and feed results into an LLM for grounded answers."
