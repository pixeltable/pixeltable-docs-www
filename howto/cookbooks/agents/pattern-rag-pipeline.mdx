---
title: "Build a RAG pipeline with Pixeltable tables"
description: "Build a retrieval-augmented generation pipeline in Pixeltable that chunks documents, embeds them, and answers questions with an LLM over your data."
