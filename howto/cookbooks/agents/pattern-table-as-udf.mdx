---
title: "Reuse a table pipeline as a UDF"
description: "Wrap an entire Pixeltable table pipeline as a reusable user-defined function you can call from queries, other tables, and agent tool definitions."
