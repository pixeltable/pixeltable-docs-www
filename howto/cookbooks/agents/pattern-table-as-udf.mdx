...
description: "Wrap a Pixeltable table pipeline as a reusable user-defined function so agents and other tables can call the entire workflow as a single tool."
