...
description: "Use retrieval UDFs in Pixeltable to fetch structured rows from tables on demand and expose them to LLM tools, prompts, and downstream pipelines."
