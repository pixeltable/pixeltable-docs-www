...
description: "Expose structured tables as retrieval UDFs so LLM agents can look up rows, fetch context, and answer questions with grounded Pixeltable data."
