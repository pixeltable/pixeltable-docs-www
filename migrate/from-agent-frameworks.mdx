---
title: "Migrate from LangGraph and CrewAI to Pixeltable"
sidebarTitle: 'Agent Frameworks'
description: "Map AI agent concepts from LangGraph, CrewAI, and similar frameworks to Pixeltable tables, computed columns, and tool-calling patterns."
---
