...
description: "Replace hand-written FastAPI endpoints with declarative Pixeltable FastAPIRouter routes that read and write tables and computed columns directly."
---
