---
title: "Migrate FastAPI endpoints to Pixeltable"
sidebarTitle: 'Hand-Written Endpoints'
description: "Replace hand-written FastAPI endpoints with declarative Pixeltable FastAPIRouter routes that serve tables, queries, and computed columns over HTTP."
---
