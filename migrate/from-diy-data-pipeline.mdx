---
title: "Migrate from DIY data pipelines to Pixeltable"
sidebarTitle: 'DIY Data Pipeline'
description: "Replace custom Python scripts, DVC, Airflow DAGs, and manual processing with declarative Pixeltable tables and incremental computed columns."
---
