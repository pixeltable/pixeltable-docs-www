---
title: "Migrate from RDBMS and vector DBs to Pixeltable"
sidebarTitle: 'RDBMS & Vector DBs'
description: "Replace Postgres plus Pinecone plus LangChain RAG stacks with a single declarative Pixeltable system that handles storage, embeddings, and retrieval."
---
