...
providers through a unified API via OpenRouter.### Prerequisites- An
OpenRouter account with an API key (https://openrouter.ai)### Important
Notes- OpenRouter usage may incur costs based on the models you use and
your usage volume.- Be mindful of sensitive data and consider security
