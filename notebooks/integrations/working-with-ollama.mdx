...
MachineIf you’re running this notebook on your own machine, running
Windows, Mac OS, or Linux, you can install Ollama at:
https://ollama.com/download \### Running on Google Colab- OR, if you’re
running on Colab, you can install Ollama by uncommenting and running the
following code.
