...
-   [Transform images with PIL
    operations](/cookbooks/images/img-pil-transforms)
-   [Convert RGB images to
    grayscale](/cookbooks/images/img-rgb-to-grayscale)
-   [Apply filters to
    images](/cookbooks/images/img-apply-filters)
