---
title: "AI application backend with Pixeltable"
description: "Use Pixeltable as the backend for AI applications, adding multimodal intelligence over images, video, audio, and text to web apps, agents, and APIs."
---
...
<Tabs>
  ...
  <Tab title="5. Serve">
    <Steps>
      <Step title="Built-in HTTP Serving">
        ...
        <CardGroup cols={2}>
          <Card title="HTTP Serving Guide" href="/howto/deployment/serving">
            TOML config, CLI, Python API, background jobs
          </Card>
          <Card title="Deployment Overview" href="/howto/deployment/overview">
            Full backend vs. orchestration layer
          </Card>
        </CardGroup>
      </Step>
      <Step title="Custom Endpoints">
        ...
        <CardGroup cols={2}>
          <Card title="Production Operations" href="/howto/deployment/operations">
...
<Tabs>
  <Tab title="Batch Processing">
    **When:** Keep existing RDBMS + blob storage
    ...
    <Card title="Batch Processing Guide" href="/howto/deployment/overview">
