---
title: "AI agents and MCP on Pixeltable"
description: "Build AI agents on Pixeltable with tool calling, persistent table-backed memory, and Model Context Protocol servers exposing data to LLM clients."
---
